...
import * as HomeSVGs from '@/components/svgs/home';
  ...
  return (
    <Main>
            ...
            <Header.TextContent>
              <Header.Title>
                ...
                <span className="inline-flex">
                  secure
                  <HomeSVGs.HeaderTitle className="w-6 h-6 lg:w-8 lg:h-8" />
                </span>
              ...
              <Header.Actions>
                ...
                <Button type="button" variant="outline" size="lg" className="border-current">
                  Watch story
      ...
      <OtherFeatures.Root className="lg:relative lg:z-10">
        <HomeSVGs.OtherFeatures className="absolute top-0 left-0 -z-10 hidden w-full h-full lg:block" />
      ...
      <MainBenefit.Root className="lg:relative lg:z-10">
        <HomeSVGs.MainBenefit className="absolute top-0 left-0 -z-10 hidden w-full h-full lg:block" />
        <Container>
          <MainBenefit.Content>
      ...
      <CreateConference.Root>
        <Container>
          <CreateConference.Content className="relative z-10">
            <HomeSVGs.CreateConference.Mobile className="absolute top-0 left-0 -z-10 w-full h-full lg:hidden" />
            <HomeSVGs.CreateConference.Desktop className="absolute top-0 left-0 -z-10 hidden w-full h-full lg:block" />
